...
function updatePioneersArray(pioneerName) {
  console.log(
    `📸 Remember to manually download an image for ${pioneerName} from Wikimedia Commons`,
  );
  console.log(
    `   Example: curl -L "https://upload.wikimedia.org/wikipedia/commons/..." -o images/${generateFilename(pioneerName)}`,
  );
}
...
async function main() {
  ...
  try {
    ...
    console.log(
      "2. Download an image from Wikimedia Commons and save it to images/",
    );
